                ...
                <div class="card-body">
                  ...
                  @enderror
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-2 mb-0">Zaloguj się</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    Nie dodałeś karty MRM?
                    <a href="{{ route('student.register') }}" class="font-weight-bold">Zarejestruj ją</a>
                  </p>
                </div>
              </div>
            </div>
