          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 active font-weight-bolder" aria-current="page" href="">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  ...
                  <p class="mb-0">Do swojej karty rabatowej MRM</p>
                </div>
                <div class="card-body">
                  <form role="form" method="post">
                      @csrf
                    <div class="mb-3">
                      <input type="text" name="card" class="form-control form-control-lg" placeholder="Numer karty" aria-label="code">
                    </div>
                    <div class="mb-3">
                      <input type="password" name="password" class="form-control form-control-lg" placeholder="Hasło" aria-label="Password">
                    </div>
                    ...
                    <div class="text-center">
                      <button type="button" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0 text-dark">Zaloguj się</button>
                    </div>
                  </form>
                </div>
